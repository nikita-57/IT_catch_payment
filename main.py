...
inline_kb_courses.add(button1, button2, button3)
...
async def process_additional_options(callback_query: types.CallbackQuery):
    ...
    if action == 'details':
        ...
        # Реализуем логику записи на курс
        await bot.send_message(callback_query.from_user.id, f'Вы успешно записались на курс {course_id}!\nНаш менеджер свяжется с вами в ближайшее время.')
